...
namespace Tiles
{
	...
	// holding a JSON manifest plus each atlas's source image embedded verbatim, so
	// a saved project never depends on the original image paths. Legacy path-referencing
